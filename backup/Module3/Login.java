       ...
       .pollingEvery(Duration.ofMillis(250)).ignoring(NoSuchElementException.class);
        wait.until(new Function<WebDriver, WebElement>() {
            ...
            public WebElement apply(WebDriver arg0) {
                WebElement elementQKart = driver.findElement(By.xpath("//div[@class='css-vb6e92']/button[1]"));
                if (elementQKart.getText().equals("LOGOUT")) {
                    System.out.println("Waiting untill login button is disappears");
                }
                return elementQKart;
            }
        });
