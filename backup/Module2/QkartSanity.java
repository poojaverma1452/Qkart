...
public class QkartSanity {
    ...
    public static Boolean TestCase06(RemoteWebDriver driver) throws InterruptedException {
        ...
        WebElement content = driver.findElement(By.xpath("//*[@id='root']/div/div/div[3]/div[2]/div/div[1]/div/div[2]/div[1]"));
        String contentsOfCart = content.getText();
        if(contentsOfCart.equals("YONEX Smash Badminton Racquet")) {
